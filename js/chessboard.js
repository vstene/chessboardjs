        ...
        function buildBoard(orientation) {
            ...
            for (var i = 0; i < 8; i++) {
                ...
                for (var j = 0; j < 8; j++) {
                    ...
                    if (cfg.showNotation === true && j === 0) {
                        html += '<span class="notation-row">' + row + '</span>';
                    }

                    if (cfg.showNotation === true && i === 7) {
                        html += '<span class="notation-column">' + COLUMNS[j].toUpperCase() + '</span>';
                    }
